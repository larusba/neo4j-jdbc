 ...
 * @since 3.2.0
 */
public class EmbeddedNeo4jStatementIT {

	public static final String JDBC_NEO4J_MEM = "jdbc:neo4j:file:target/test-db";
	...
	@Test public void executeQueryShouldExecuteAndReturnCorrectData() throws SQLException {
		EmbeddedNeo4jConnection connection = (EmbeddedNeo4jConnection) DriverManager.getConnection(JDBC_NEO4J_MEM);
