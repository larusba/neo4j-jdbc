 ...
 * @since 3.2.0
 */
public class ImpermanentNeo4jConnection extends Neo4jConnection {
...
//	private Transaction          transaction;
	...
	public ImpermanentNeo4jConnection(GraphDatabaseService db, Properties properties, String url) {
	 ...
	 */
	public ImpermanentNeo4jConnection(GraphDatabaseService db) {
	...
	@Override public Neo4jStatement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		...
		return new ImpermanentNeo4jStatement(this, resultSetType, resultSetConcurrency, resultSetHoldability);
	}
	...
	@Override public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		...
		this.checkConcurrencyParams(resultSetConcurrency);
		this.checkHoldabilityParams(resultSetHoldability);
		return new ImpermanentNeo4jPreparedStatement(this, nativeSQL(sql), resultSetType, resultSetConcurrency, resultSetHoldability);
	}
