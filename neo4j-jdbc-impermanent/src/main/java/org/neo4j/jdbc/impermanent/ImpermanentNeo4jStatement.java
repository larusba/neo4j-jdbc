 ...
 * @since 3.2.0
 */
public class ImpermanentNeo4jStatement extends Neo4jStatement {
	 ...
	 */
	public ImpermanentNeo4jStatement(ImpermanentNeo4jConnection connection, int... rsParams) {
	...
	@Override public ResultSet executeQuery(String sql) throws SQLException {
		...
		this.currentResultSet = new ImpermanentNeo4jResultSet(this, result, this.rsParams);
	...
	private ResultWrapper executeInternal(String sql) throws SQLException {
		...
		GraphDatabaseService graphDatabaseService = ((ImpermanentNeo4jConnection) this.getConnection()).getGraphDatabaseService();
		Result result;
		...
		return rw;*/
		return ((ImpermanentNeo4jConnection) this.getConnection()).execute(sql);
	}
