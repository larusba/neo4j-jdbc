...
import org.neo4j.jdbc.impermanent.test.data.ImpermanentResultSetData;
 ...
 * @since 3.2.0
 */
public class ImpermanentNeo4jResultSetTest {
	@Rule
	...
	@Test public void isClosedReturnFalseWhenConnectionOpen() throws SQLException {
		...
		Neo4jResultSet resultSet = new ImpermanentNeo4jResultSet(null, rw);
	...
	@Test public void closeShouldThrowExceptionIfIteratorIsNull() throws SQLException {
		...
		Neo4jResultSet resultSet = new ImpermanentNeo4jResultSet(null, null);
	...
	//		Neo4jResultSet resultSet = new ImpermanentNeo4jResultSet(stmt, result);
	//
	//		resultSet.next();
	...
	//		Result result = ImpermanentResultSetData
	//				.buildResultCursor(ImpermanentResultSetData.KEYS_RECORD_LIST_MORE_ELEMENTS_NODES, ImpermanentResultSetData.RECORD_LIST_MORE_ELEMENTS_NODES);
	//		ResultWrapper rw = new ResultWrapper(result); 		Neo4jResultSet resultSet = new ImpermanentNeo4jResultSet(null, rw);
	//
	//		resultSet.next();
	...
	//		ResultWrapper rw = new ResultWrapper(spyCursor); 		Neo4jResultSet resultSet = new ImpermanentNeo4jResultSet(null, rw);
	//
	//		resultSet.close();
